...
=======
                <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">{{ $t('Work with us') }}</h2>
                <p class="mt-6 text-lg leading-8 text-gray-300">
                    {{ $t('Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.') }}
                </p>
