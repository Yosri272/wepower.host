...
<<<<<<< HEAD
                                                ...
                                                <input type="text" id="Area" placeholder="Enter Area" class="form-input"
=======
                                                <label for="Area" class="form-label mb-2"> {{ $t('Area') }}</label>
...
<<<<<<< HEAD
                                                ...
                                                <input type="text" id="Flat" placeholder="Enter Flat no" value=""
=======
...
>>>>>>> aa6c636e1 (أول رفع لموقع wepower.host)
                                            ...
                                            <div>
<<<<<<< HEAD
                                                <label for="Postal" class="form-label mb-2"> Postal Code
                                                    <small>*</small></label>
                                                <input type="text" id="Postal" v-model="formData.post_code"
                                                    placeholder="Enter Postal Code" value="" class="form-input"
=======
...
>>>>>>> aa6c636e1 (أول رفع لموقع wepower.host)
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                                            <div>
<<<<<<< HEAD
                                                <label for="address" class="form-label mb-2"> Address Line 1
                                                    <small>*</small></label>
                                                <input type="text" id="address" v-model="formData.address_line"
                                                    placeholder="Enter address 1" class="form-input"
=======
...
<<<<<<< HEAD
                                                ...
                                                <input type="text" id="address2" v-model="formData.address_line2"
                                                    placeholder="Enter address 2" value="" class="form-input"
=======
