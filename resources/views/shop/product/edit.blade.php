...
<<<<<<< HEAD
                        <select name="color[]" data-placeholder="Select Color" class="form-control colorSelect" multiple
                            style="width: 100%">
=======
                        <select name="colorIds[]" data-placeholder="Select Color" class="form-control colorSelect" multiple style="width: 100%">
>>>>>>> aa6c636e1 (أول رفع لموقع wepower.host)
                            <option value="">
                                {{ __('Select Color') }}
                            </option>
...
=======
                                <option value="{{ $color->id }}" data-color="{{ $color->color_code }}" data-name="{{ $color->name }}" {{ in_array($color->id, $product->colors?->pluck('id')->toArray()) ? 'selected' : '' }}>
>>>>>>> aa6c636e1 (أول رفع لموقع wepower.host)
                                    {{ $color->name }}
                                </option>
                            @endforeach
...
<<<<<<< HEAD
                        <x-input type="text" name="price" label="Product Price" placeholder="Product Price"
=======
...
<<<<<<< HEAD
                    ...
                    <div class="col-lg-3 col-md-6 mt-3 mt-lg-0">
                        <x-input type="text" onlyNumber="true" name="min_order_quantity"
                            label="Minimum Order Quantity" placeholder="Minimum Order Quantity" required="true"
...
=======
                ...
                <div class="border rounded p-0 position-relative overflow-hidden" id="colorBox" @if ($product->colors->isEmpty()) style="display: none" @endif>
                                ...
                                <tr id="selectedColorRow_{{ $color->id }}" style="display: table-row !important">
                                    <td>
                                        <h4 class="mb-0 boxName d-flex align-items-center gap-1">
                                            <span style="background-color:{{ $color->color_code }};width:20px;height:19px;display:inline-block; border-radius:5px;"></span>
                                            {{ $color->name }}
                                        </h4>
                                        <input type="hidden" name="color[{{ $color->id }}][name]"
                                            value="{{ $color->name }}">
                                        <input type="hidden" name="color[{{ $color->id }}][id]" value="{{ $color->id }}">
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <input type="text" class="form-control extraPriceForm"
                                                name="color[{{ $color->id }}][price]" value="{{ $color->pivot->price }}"
                                                style="width: 140px" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr id="selectedSizeRow_{{ $size->id }}">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <input type="text" class="form-control extraPriceForm"
                                                name="size[{{ $size->id }}][price]"
                                                value="{{ $size->pivot->price }}" style="width: 140px" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        </div>
                                    </td>
                                    <td>
                                        <button class="btn circleIcon btn-outline-danger btn-sm" type="button"
...
=======
                                            ...
                                            <img src="{{ asset('assets/icons-admin/trash.svg') }}" loading="lazy" alt="trash" />
>>>>>>> aa6c636e1 (أول رفع لموقع wepower.host)
                                        </a>
                                    </label>
            ...
            <div class="card-body">
                ...
                <div class="mt-3 d-flex gap-2">
                    ...
                    <div class="mb-3 flex-grow-1" id="fileUploadField">
                        ...
                        <input type="file" class="form-control" name="uploadVideo[file]" id="productVideo" accept="video/*">
        ...
        <div class="card mt-4 mb-3">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <x-input name="meta_title" type="text" placeholder="Meta Title" value="{{ old('meta_title', $product->meta_title) }}" />
                </div>
...
=======
                            ...
                            $.each(data.data.sub_categories, function(key, value) {
                                subCategorySelected.append('<option value="' + value.id +
                                    '">' + value.name + '</option>');
                            });
