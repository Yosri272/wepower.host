...
=======
@section('header-title', __('Add New Promo Code'))

@section('content')
    <div class="page-title">
        <div class="d-flex gap-2 align-items-center text-muted">
            <i class="bi bi-plus-circle"></i> {{ __('Add New Promo Code') }}
...
=======
                            <i class="bi bi-patch-plus"></i> {{ __('Add New Promo Code') }}
>>>>>>> aa6c636e1 (أول رفع لموقع wepower.host)
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-12 mb-3">
                                <x-select name="shops[]" label="{{ __('Select shops') }}" placeholder="{{__('Select shops')}}" multiselect="true">
                                    ...
                                    @foreach ($shops as $shop)
                                        <option {{ $businessModel == 'single' ? 'selected' : '' }} value="{{ $shop->id }}">
                                            {{ $shop->name }}
                                        </option>
                                    @endforeach
                                </x-select>
