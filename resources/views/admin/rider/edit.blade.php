...
<<<<<<< HEAD
=======
@section('header-title', __('Edit Rider'))
...
<<<<<<< HEAD
                                        <x-input label="First Name" name="first_name" type="text" placeholder="Enter first name" :value="$user?->name" />
                                    </div>
...
=======
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        <x-input label="Last Name" name="last_name" type="text" placeholder="Enter last name" :value="$user->last_name" />
>>>>>>> aa6c636e1 (أول رفع لموقع wepower.host)
                                    </div>
                                </div>
                                <div class="mt-3">
...
<<<<<<< HEAD
                                        placeholder="Enter Vehicle Type" :value="$user?->vehicle_type" />
=======
