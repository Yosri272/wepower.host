                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    @if($currency->symbol == 'ريال')
                                        <img src="{{ asset('assets/images/riyals.png') }}" alt="Riyal" width="30" height="30" class="me-2">
                                    @endif
                                    <x-input name="symbol" type="text" placeholder="Currency Symbol exm:($,৳,₹)" required="true" :value="$currency->symbol" />
                                </div>
                            </div>
